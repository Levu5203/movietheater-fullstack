...
private readonly IConfiguration _configuration;
    ...
    public TokenService(IConfiguration configuration, IUnitOfWork unitOfWork)
    {
        ...
        _key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_configuration["JWT:Secret"] ?? "group4fsoft@hotmail.com"));
    }
    ...
    public async Task<RefreshToken?> ValidateRefreshTokenAsync(string token)
    {
        ...
        return refreshToken?.IsActive ?? false ? refreshToken : null;
    }
